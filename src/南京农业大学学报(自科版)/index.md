...
<div class="csl-bib-body maxoffset-303 second-field-align-false hangingindent-false">
  ...
  <div class="csl-entry">[7] 肖玲,张雪, 王永. 数据要素的统计测算方法探究[A]. PSSXiv,2024.
    <div class="csl-block">Xiao L,Zhang X,Wang Y. Exploring statistical measurement methods for data elements[A]. PSSXiv,2024(in Chinese with English abstract).</div>
   </div>
